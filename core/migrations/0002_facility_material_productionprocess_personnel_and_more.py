    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('produced_quantity', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.AlterField(
            model_name='project',
            name='project_number',
            field=models.CharField(help_text='Simple project number (e.g., 1001)', max_length=10, unique=True, verbose_name='Project #'),
        ),
        migrations.AlterField(
            model_name='building',
            name='name',
            field=models.CharField(default='Building A', help_text='Building name (e.g., "Building A", "Building B")', max_length=100),
        ),
